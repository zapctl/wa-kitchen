function(t, n, r, o, a, i, l){
  function e(e){
    ...
    return o("WAResultOrError").makeResult({
        jid: n.value, displayNameMixin: r.success ? r.value: null
      })
}
function s(t, n){
  ...
  return g.success ? o("WAResultOrError").makeResult({
        type: s.value, listMatched: d.value, hasListCDhash: p.value != null, listDhash: _.value, listAddressingMode: f.value, listItem: g.value
      })
  : g
}
